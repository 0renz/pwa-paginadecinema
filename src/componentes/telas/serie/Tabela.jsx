...
function Tabela() {
    ...
    const { alerta, listaObjetos, remover, novoObjeto, editarObjeto } = useContext(SerieContext);
    ...
    return (
        <div style={{ padding: '20px' }}>
            ...
            {listaObjetos.length === 0 && <h1>Nenhuma série encontrada</h1>}
